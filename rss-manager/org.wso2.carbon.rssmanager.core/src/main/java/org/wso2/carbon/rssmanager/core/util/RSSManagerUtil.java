...
public final class RSSManagerUtil {
	...
	public static DataSourceMetaInfo createDSMetaInfo(DatabaseInfo database,
	                                                  String username, String password, String dataSourceName) throws RSSManagerException {
	 ...
	 */
	public static void createDatabasePrivilegeSetInfo(DatabasePrivilegeSetInfo privilegeSetInfo, DatabasePrivilegeSet privilegeSet) {
	 ...
	 */
	public static void createDatabasePrivilegeTemplateInfo(DatabasePrivilegeTemplateInfo privilegeTemplateInfo, DatabasePrivilegeTemplate template) {
	 ...
	 */
	public static void createDatabasePrivilegeSet(DatabasePrivilegeSetInfo privilegeSetInfo, DatabasePrivilegeSet privilegeSet) {
		if (privilegeSetInfo == null || privilegeSet == null) {
			return;
		}
	 ...
	 */
	public static void createDatabasePrivilegeTemplate(DatabasePrivilegeTemplateInfo privilegeTemplateInfo, DatabasePrivilegeTemplate template) {
		if (privilegeTemplateInfo == null || template == null) {
			return;
		}
	 ...
	 */
	public static void createDatabasePrivilegeTemplateEntry(DatabasePrivilegeSet databasePrivilegeSet, DatabasePrivilegeTemplateEntry entry) {
	 ...
	 */
	public static void createDatabasePrivilegeSet(DatabasePrivilegeSet privilegeSet, DatabasePrivilegeTemplateEntry entry) {
