...
public class RSSManagerServiceComponent {
	...
	protected void activate(ComponentContext componentContext) {
		...
		try {
	        ...
	        bundleContext.registerService(Axis2ConfigurationContextObserver.class.getName(),
	                  	                new RSSAdminAxis2ConfigContextObserver(), null);
    ...
    protected void setConfigurationContextService(
        ...
        RSSManagerDataHolder.getInstance().setContextService(configurationContextService);
    }
    ...
    protected void unsetConfigurationContextService(
            ConfigurationContextService configurationContextService) {
        RSSManagerDataHolder.getInstance().setContextService(null);
    }
    ...
    protected void setRegistryService(RegistryService registryService) {
        RSSManagerDataHolder.getInstance().setRegistryService(registryService);
    }
    ...
    protected void unsetRegistryService(RegistryService registryService) {
        RSSManagerDataHolder.getInstance().setRegistryService(null);
    }
