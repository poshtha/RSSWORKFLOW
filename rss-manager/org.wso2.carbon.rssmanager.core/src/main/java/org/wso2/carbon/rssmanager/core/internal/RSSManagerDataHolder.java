...
public class RSSManagerDataHolder {
	...
	public void addWorkFlowConfig(int tid, WorkflowExecutorConfig conf) {
		workflowExecutorConfigTenantMap.put(tid, conf);
	}
	
	public WorkflowExecutorConfig getWorkFlowConfig(int tid) {
        return workflowExecutorConfigTenantMap.get(tid);
	}
	...
	public Registry getRegistry() throws RegistryException {
		return registryService.getConfigUserRegistry();
	}
